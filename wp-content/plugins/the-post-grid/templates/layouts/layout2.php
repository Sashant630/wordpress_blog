...
if ( in_array( 'post_date', $items ) && $date ) {
	...
	if ( $metaIcon ) {
		$metaHtml .= "<i class='" . Fns::change_icon( 'far fa-calendar-alt', 'flaticon-calendar' ) . "'></i>";
	}
...
if ( in_array( 'author', $items ) ) {
	...
	if ( $metaIcon ) {
		$metaHtml .= "<i class='" . Fns::change_icon( 'fa fa-user', 'flaticon-user' ) . "'></i>";
	}
...
if ( in_array( 'tags', $items ) && $tags ) {
	...
	if ( $metaIcon ) {
		$metaHtml .= "<i class='" . Fns::change_icon( 'fa fa-tags', 'flaticon-tag' ) . "'></i>";
	}
...
if ( in_array( 'comment_count', $items ) ) {
	...
	if ( $metaIcon ) {
		$metaHtml .= "<i class='". Fns::change_icon( 'fas fa-comments', 'flaticon-chat' ) . "'></i>";
	}
